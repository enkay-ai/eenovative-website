...
Production multi-page static site for **Eenovative Technologies** ("Where Intelligence Meets Innovation").
...
```
├── index.html            Home (3D synapse-field hero)
├── solutions.html        Services, expertise, delivery process
├── programmes.html       Digital Literacy Initiative, AI & Coding Club
├── products.html         Products + case studies
├── about.html            Mission, values, trust principles
├── contact.html          Form, packages, FAQs
